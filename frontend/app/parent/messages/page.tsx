        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[600px]">
                <Card className="lg:col-span-1 overflow-hidden flex flex-col">
                    <CardHeader className="pb-3"><CardTitle className="text-lg flex items-center justify-between">Conversations {contacts.some(c => c.unread) && <Badge variant="destructive" className="text-xs">{contacts.filter(c => c.unread).length} new</Badge>}</CardTitle></CardHeader>
